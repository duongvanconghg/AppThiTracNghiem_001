...
public class ScreenSlidePageFragmentTiengviet extends Fragment {
    ...
    public ScreenSlidePageFragmentTiengviet() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_screen_slide_page_toan, container, false);
    ...
    public static ScreenSlidePageFragmentToan create(int pageNumber, int checkAnswer) {
        ScreenSlidePageFragmentToan fragment = new ScreenSlidePageFragmentToan();
