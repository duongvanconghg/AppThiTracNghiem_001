...
//                Toast.makeText(ScreenSlidePagerActivity.this, i, Toast.LENGTH_SHORT).show();
        ...
        if (test.equals("yes")) {
            ArrayList<Question> list = questionController.getQuestion(num_exam, subject);
            arr_Ques = questionController.mixQuestions(list);
    ...
    private class ScreenSlidePagerAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            ...
            switch (subject){
                ...
                case "toan":
                    Log.e("toan","");
                    return ScreenSlidePageFragmentToan.create(position,checkAns);
                default:
                    Log.e("default","");
                    break;
                    //khong lam gi ca
